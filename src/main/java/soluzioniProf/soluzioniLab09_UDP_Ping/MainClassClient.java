package soluzioniProf.soluzioniLab09_UDP_Ping;
...
public class MainClassClient {
     ...
     */
    final static int DEFAULT_TIME_PORT = 30001;


    public static void main(String[] args){
        /*
        Configurazione RUN per Multicast
        -Djava.net.preferIPv4Stack=true (fondamentale per client)
         */
