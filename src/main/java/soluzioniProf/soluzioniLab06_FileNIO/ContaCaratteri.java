package soluzioniProf.soluzioniLab06_FileNIO;
...
public class ContaCaratteri {
	...
	public static void main(String[] args) throws IOException {
		...
		//read input file
		try (ReadableByteChannel readChannel= FileChannel.open(Paths.get("src/main/java/soluzioniProf/soluzioniLab06_FileNIO/lipsum"), StandardOpenOption.READ);
			 WritableByteChannel outChannel= FileChannel.open(Paths.get("src/main/java/soluzioniProf/soluzioniLab06_FileNIO/frequency"), StandardOpenOption.WRITE, StandardOpenOption.CREATE)){
